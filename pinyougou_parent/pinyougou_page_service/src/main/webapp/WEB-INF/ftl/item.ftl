            ...
            <div class="fl preview-wrap">
                ...
                <div class="zoom">
                    ...
                    <div class="spec-scroll">
                        ...
                        <div class="items">
                            <ul>
                                <#list imageList as pic>
                                    <li><img src="${pic.url}" bimg=" ${pic.url}" onmousemove="preview(this)"/></li>
                                </#list>
                            </ul>
                        </div>
                        <a class="next">&gt;</a>
                        ...
                        <#list specificationItemsList as spec>
                            <dl>
                                ...
                                <#list spec.attributeValue as item>
                                    <dd><a href="javascript:void (0);" class="{{isSelected('${spec.attributeName}','${item}')?'selected':''}}"
                    ...
                    <div class="summary-wrap">
                        ...
                        <div class="fl">
                            <ul class="btn-choose unstyled">
                                <li>
                                    <a href="javascript:void(0)" ng-click="addToCart()" target="_blank"   class="sui-btn  btn-danger addshopcar">加入购物车</a>
                                </li>
                            </ul>
                        </div>
                    </div>
